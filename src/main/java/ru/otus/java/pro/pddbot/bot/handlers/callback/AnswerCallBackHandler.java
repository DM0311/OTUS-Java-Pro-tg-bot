...
public class AnswerCallBackHandler implements CallBackHandler {
    ...
    public EditMessageWrapper acceptAnswer(Long chatId, Long telegramId, String callbackData, Integer messageId) {
        ...
        EditMessageWrapper messageWrapper = new EditMessageWrapper();
        ...
        if (updatedSession == null || updatedSession.isCompleted()) {
            messageWrapper.setFinalMessage(true);
            messageWrapper.setEditMessageText(getExamResults(user, chatId, messageId, session));
        ...
        messageWrapper.setEditMessageText(editMessage);
        return messageWrapper;
    }
